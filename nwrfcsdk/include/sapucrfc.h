/* @(#) $Id: //bas/754_REL/src/include/sapucrfc.h#4 $ SAP*/
/* CCQ_CCU_FILE_OFF */ /* CCQ_COV_FILE_OFF */ /* CCQ_IPV6_SUPPORT_FILE_OK */ /* CCQ_USE_TIME_T_FILE_OK */
#ifndef SAPUCRFC_H
#define SAPUCRFC_H "$Id: //bas/754_REL/src/include/sapucrfc.h#4 $"
...
#if defined(SAPonLIN) || defined(SAPonSUN)
  #if defined(SAPccQ) && (__GNUC__ == 3)
    /* current ccQ (based on gcc-3.3.3) does not yet know char16_t */
    typedef unsigned short char16_t;
  #else
 ...
 *     #define SAP_IDENT "@(#) $Id: //bas/754_REL/src/include/sapucrfc.h#4 $"
 ...
 *     SAP_IDENTN(name,"@(#) $Id: //bas/754_REL/src/include/sapucrfc.h#4 $")
...
#define getcU(stream)                    NUC_UC(/*CCQ_RAWDECL*/getc,fgetcU16)(stream)
...
#define putcU(c, stream)                 NUC_UC(/*CCQ_RAWDECL*/putc,fputcU16)(c, stream)
...
#else
  #if defined(SAPonOS400) && defined(SAPwithCHAR_ASCII)
  #define DECLAREenvironR               extern /*SAPUNICODEOK_CHARTYPE*/char ** o4_environ_a
  #else
  #define DECLAREenvironR               extern /*SAPUNICODEOK_CHARTYPE*/char ** environ
  #endif
#endif
#ifdef SAPonOS400
